...
/*
 * LGE_CHANGE - M7630AABBQMLZA404031I kernel panic
 * MSG_MASK_SIZE has been changed from 8000  to 9500 so READ_BUF_SIZE should also be increased.
 * if not, read_buffer[] will be overflowed in diagchar_read() and this will cause kernel panic
 * plz have a look at system.map. things followed by read_buffer will be corrupted.
 */
#define READ_BUF_SIZE 100000 // 8004 -> 100000, refer to diag_lsm.c
