...
static struct led_flash_platform_data *lm3559_led_flash_pdata;
static struct i2c_client *lm3559_i2c_client;
...
void lm3559_config_gpio_on(void)
{
	...
	pr_err("%s: Start gpio = %d\n", __func__,lm3559_led_flash_pdata->gpio_en);
