...
static struct usb_endpoint_descriptor acm_hs_notify_desc = {
	...
	.bEndpointAddress =	USB_DIR_IN,
	.bmAttributes =		USB_ENDPOINT_XFER_INT,
/* LGE_CHANGE_S [START] 2012.4.17 jaeho.cho@lge.com change notification max packet size  */
#ifdef CONFIG_USB_G_LGE_ANDROID
	.wMaxPacketSize =	cpu_to_le16(GS_DESC_NOTIFY_MAXPACKET),
#else
	.wMaxPacketSize =	cpu_to_le16(GS_NOTIFY_MAXPACKET),
#endif
/* LGE_CHANGE_S [END] 2012.4.17 jaeho.cho@lge.com change notification max packet size  */
