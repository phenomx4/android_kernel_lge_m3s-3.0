...
//LGE_CHANGE_S CAMERA FIRMWARE UPDATE (keonwoo01.park@lge.com) 임시로 막음
...
//LGE_CHANGE_E CAMERA FIRMWARE UPDATE (keonwoo01.park@lge.com) 임시로 막음
...
MACHINE_START(MSM7X30_U0, "LGE MSM7X30 U0")
