...
typedef enum {
	...
	CUSTOMER_CMD1_GET_CABLE_TYPE,		
	CUSTOMER_CMD1_RESERVED1,
	CUSTOMER_CMD1_RESERVED2,	
...
enum {
	...
	PCOM_OEM_AP_PANIC_CMD = PCOM_OEM_FIRST_CMD + 10,
	PCOM_OEM_MODEM_PANIC_CMD,
	PCOM_OEM_SET_DUMP_MODE_CMD,
	PCOM_OEM_SET_AUTO_ACTION_TYPE_CMD,
	PCOM_OEM_ERS_LAST_CMD = PCOM_OEM_FIRST_CMD + 19,
#endif
//LGE_CHANGE_S[TestMode][jinhwan.do@lge.com] 2012-02-16, Test Mode Porting of PowerSaveMode [Start]
	PCOM_OEM_SET_FTM_MODE_CMD,
	PCOM_OEM_GET_FTM_MODE_CMD,
	PCOM_OEM_SET_OPERATION_MODE_CMD,
	PCOM_OEM_SET_FTMBOOT_RESET_CMD,
//LGE_CHANGE_S[TestMode][jinhwan.do@lge.com] 2012-02-16, Test Mode Porting of PowerSaveMode [END]
#ifdef CONFIG_MACH_MSM7630_U0
	PCOM_LGE_LAST = PCOM_OEM_FIRST_CMD + 30,
	PCOM_OEM_LAST = PCOM_LGE_LAST,
#else
