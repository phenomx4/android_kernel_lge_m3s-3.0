...
#define ATCMD_ATD	  79
#define ATCMD_MTC	  80 // AT+MTC

// use AT COMMAND to receive the eri file from modem and save in data directory
// careful of the permission to write eri file in the data directory, you may need to create eri folder in advance, see init.xx.rc
#ifdef CONFIG_LGE_ERI_DOWNLOAD
#define ATCMD_ERI_DLOAD	81
#define ERI_FILENAME "data/eri/eri.bin"
#endif


// MOD 0010090: [FactoryReset] Enable Recovery mode FactoryReset
#define MP2AP_CALBACKUP	90
...
#define ATCMD_ICD	95
#define ATCMD_ICD_LOGGING_START	1
#define ATCMD_ICD_LOGGING_END	2
#endif
