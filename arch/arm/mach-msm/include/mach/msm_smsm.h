...
enum {
	...
	SMEM_PCB_REV = SMEM_KEYPAD_STATE_IDX,
#endif
	SMEM_GPIO_INT,
	SMEM_MDDI_LCD_IDX,
...
#ifdef CONFIG_LGE_SMEM
	SMEM_LGE_START = 500, //need to keep enum value, add items below
#ifdef CONFIG_LGE_USB_STORE_PID
	SMEM_DLOAD_USB_PID = SMEM_LGE_START, 
#endif
	SMEM_LGE_LAST,
	SMEM_MEM_LAST = SMEM_LGE_LAST,
#else
