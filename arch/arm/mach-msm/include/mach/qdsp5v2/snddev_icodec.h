...
#define DEVICE_ID_INTERNAL_HANDSET_LOOPBACK_TX  DEVICE_ID_INTERNAL_VOICE_REC +1
#define DEVICE_ID_INTERNAL_HEADSET_LOOPBACK_TX  DEVICE_ID_INTERNAL_HANDSET_LOOPBACK_TX +1

#define DEVICE_ID_EXTERNAL_BT_SCO_VOICE_RX  DEVICE_ID_INTERNAL_HEADSET_LOOPBACK_TX + 1
